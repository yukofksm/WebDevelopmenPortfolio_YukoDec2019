    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact" action="action/userAction.php" method="post" id="contact" novalidate="novalidate">
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" name="send" class="btn boxed-btn">Send</button>
                            </div>
                        </form>
                    </div>
