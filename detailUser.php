    ...
    <div class="container w-50 mx-auto mt-5">
        <div class="card">
            <div class="card-header">
                <h3 class="display-4 ml-3">User Detail</h3>
            </div>
            <div class="card-body">
                <p><i class="fas fa-key"></i>  # <?php echo $result['user_id']?></p><br>
                <p><i class="fas fa-user"></i>Guest Name:  <?php echo $result['firstname']?> <?php echo $result['lastname']?></p><br>
                <p><i class="fas fa-fish"></i>Gemder:  <?php echo $result['gender']?></p><br>
                <p><i class="fas fa-phone-alt"></i>Contact Number:<?php echo $result['number']?></p><br>
